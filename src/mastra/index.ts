...
// Register the stock analysis workflow as a cron job for 5:30 PM IST daily
// Using Asia/Kolkata timezone for IST and running at 5:30 PM (17:30)
registerCronWorkflow(
  `TZ=${process.env.SCHEDULE_CRON_TIMEZONE || 'Asia/Kolkata'} ${process.env.SCHEDULE_CRON_EXPRESSION || '30 17 * * *'}`, 
